...
function findText(){
    if( n == 0 ){
        inputText = "hackday是一项交流技术...助你长胖的活动<br>总之是来了不会后悔活动";
    }else if (n==1) {
        inputText = "每年我们都会抽出24小时的时间，<br>让一群产品狗，程序猿，设计狮汇聚一堂，组成一个个新的团队，<br>将头脑风暴中稀奇古怪的点子，日思夜想的产品变成现实。<br>在这有限的24小时中，我们希望大家能够迸发自己的创造力，<br>互相增进了解，学会进行团队合作开发，<br>最后完成一款炫酷的产品。It's amazing so amazing.";
    }else if( n ==2 ){
